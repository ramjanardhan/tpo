                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    ...
                                    <s:select cssClass="form-control" headerKey="-1" headerValue="--select--" list="#@java.util.LinkedHashMap@{'US':'USA','IN':'India','CN':'Canada','UK':'United Kingdom'}" name="regcountry" id="regcountry" value="%{country}" />
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
