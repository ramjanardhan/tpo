                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <s:select headerKey="-1" headerValue="--select--" cssClass="form-control" list="myUsersList" name="contactName" id="contactName" value="%{contactName}" onchange="showUserPwdBox()" tabindex="1"/>
                                </div>
                            </div>
                        </div>
