                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <s:select headerKey="-1" headerValue="--select--" cssClass="form-control" list="partnerNameList" name="partnerName" id="partnerName" value="%{partnerName}" onchange="showPwdBox()"/>
                                </div>
                            </div>
                        </div>
