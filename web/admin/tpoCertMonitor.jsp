...
<html lang="en">
    ...
    <%--  <link rel="stylesheet" href='<s:url value="/includes/css/daterangepicker.css"/>' type="text/css"/> --%>
  ...
  <link rel="stylesheet" href='<s:url value="/includes/plugins/datatables/dataTables.bootstrap.css"/>' type="text/css">
    ...
    <body class="home" onload="doOnLoad()">
     ...
     <%-- <script language="JavaScript" src='<s:url value="/includes/js/moment.js"/>'></script>
        <script language="JavaScript" src='<s:url value="/includes/js/moment.min.js"/>'></script>
        <script language="JavaScript" src='<s:url value="/includes/js/daterangepicker.js"/>'></script>  --%>
